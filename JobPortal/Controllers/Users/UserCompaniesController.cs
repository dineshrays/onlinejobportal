...
namespace Jobportal.User.Controllers
{
    public class UserCompaniesController:Controller
    {
        ...
        {
            var busstream = new SelectList(db.IndustryTypes.ToList(), "id", "BusinessStreamName");
      ...
      //  [ValidateAntiForgeryToken]
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.BusinessStreamId = new SelectList(db.IndustryTypes, "id", "BusinessStreamName", company.IndustryId);
            return View(company);
        }
